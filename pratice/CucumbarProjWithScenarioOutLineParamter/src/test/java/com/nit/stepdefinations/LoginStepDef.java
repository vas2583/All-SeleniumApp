...
public class LoginStepDef {
	...
	public void i_wnat_enter_the_valid_password(String pwd) {
	...
	public void i_wnat_enter_the_invalid_password(String inpwd) {
		driver.findElement(By.name("password")).sendKeys(inpwd);
	}
