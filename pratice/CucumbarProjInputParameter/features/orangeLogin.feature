...
Given i want open browser
When i want navigate to OrangeHRM Home Page
And i want enter valid userName "Admin"
And i wnat Enter the valid password "admin123"
...
Given i want open browser
When i want navigate to OrangeHRM Home Page
And i want enter Invalid User Name "adm"
And i wnat Enter the Invalid password "adm12"
And i want Click On Login button
